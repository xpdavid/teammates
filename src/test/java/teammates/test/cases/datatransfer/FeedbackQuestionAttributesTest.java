...
public class FeedbackQuestionAttributesTest extends BaseAttributesTest {
    ...
    @Test
    public void testBuilder_withIrrelevantFeedbackPaticipant_shouldGenerateAttributesCorrectly() {
    ...
    public void testBuilder_buildNothing_shouldUseDefaultValues() {
        ...
        assertNull(observedFeedbackQuestionAttributes.getQuestionType());
        assertNull(observedFeedbackQuestionAttributes.getQuestionMetaData());
