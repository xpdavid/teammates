...
public class FeedbackResponsesLogicTest extends BaseLogicTest {
    ...
    public void testGetGiverSetThatAnswerFeedbackSession_giverIsUser_shouldReturnCorrectIdentifier() {
        Set<String> giverSet = frLogic.getGiverSetThatAnswerFeedbackSession("idOfTypicalCourse1", "First feedback session");
    ...
    @Test
    public void testDeleteFeedbackResponsesInvolvedEntityOfCourseCascade_typicalEntity_shouldDeleteRelatedResponses() {
