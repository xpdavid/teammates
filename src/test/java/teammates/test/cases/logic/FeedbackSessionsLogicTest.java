...
public class FeedbackSessionsLogicTest extends BaseLogicTest {
    ...
    public void testUpdateFeedbackSession_shouldAdjustEmailSendingStatusAccordingly() throws Exception {
        ...
        ______TS("open email sent, whether the updated session is open determine the open email sending status");
        ...
        ______TS("closed email sent, whether the updated session is closed determine the "
        ...
        ______TS("published email sent, whether the updated session is published determine the "
