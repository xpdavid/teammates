...
public abstract class BasicFeedbackSubmissionAction extends Action {
     ...
     */
    protected void checkAccessControlOfStudentFeedbackSubmission(
        ...
        if (!StringHelper.isEmpty(moderatedPerson)) {
            gateKeeper.verifyAccessible(logic.getInstructorForGoogleId(
                    feedbackSession.getCourseId(), userInfo.getId()), feedbackSession,
                    false, student.getSection(),
    ...
    /**
     * Verifies that is is not a preview request.
     */
     ...
     */
    protected void validResponseOfQuestion(
            FeedbackQuestionAttributes questionAttributes, FeedbackResponseAttributes responseToValidate) {
