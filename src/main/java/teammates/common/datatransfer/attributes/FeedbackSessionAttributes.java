...
public class FeedbackSessionAttributes extends EntityAttributes<FeedbackSession> implements SessionAttributes {
    ...
    public void update(UpdateOptions updateOptions) {
        ...
        updateOptions.createdTimeOption.ifPresent(s -> createdTime = s);
        ...
        updateOptions.isOpeningEmailEnabledOption.ifPresent(s -> isOpeningEmailEnabled = s);
        ...
        updateOptions.respondingStudentSetOption.ifPresent(s -> respondingStudentList = new HashSet<>(s));
        updateOptions.respondingInstructorSetOption.ifPresent(s -> respondingInstructorList = new HashSet<>(s));
    ...
    public static class UpdateOptions {
        ...
        private UpdateOption<Instant> createdTimeOption = UpdateOption.empty();
        ...
        private UpdateOption<Boolean> isOpeningEmailEnabledOption = UpdateOption.empty();
        ...
        private UpdateOption<Set<String>> respondingStudentSetOption = UpdateOption.empty();
        private UpdateOption<Set<String>> respondingInstructorSetOption = UpdateOption.empty();
        ...
        /**
         * Represents the change of email for instructor/student.
         */
        ...
        public static class Builder {
            ...
            public Builder withCreatedTime(Instant createdTimeOption) {
                Assumption.assertNotNull(Const.StatusCodes.UPDATE_OPTIONS_NULL_INPUT, createdTimeOption);

                updateOptions.createdTimeOption = UpdateOption.of(createdTimeOption);
                return this;
            }

            public Builder withDeletedTime(Instant deletedTimeOption) {
                // deleted time can be set to null
                updateOptions.deletedTimeOption = UpdateOption.of(deletedTimeOption);
                return this;
            }
            ...
            public Builder withIsOpeningEmailEnabled(boolean isOpeningEmailEnabled) {
                updateOptions.isOpeningEmailEnabledOption = UpdateOption.of(isOpeningEmailEnabled);
                return this;
            }
            ...
            public Builder withRespondingStudentSet(Set<String> respondingStudentSet) {
                Assumption.assertNotNull(Const.StatusCodes.UPDATE_OPTIONS_NULL_INPUT, respondingStudentSet);

                updateOptions.respondingStudentSetOption = UpdateOption.of(respondingStudentSet);
                return this;
            }

            public Builder withRespondingInstructorSet(Set<String> respondingInstructorSet) {
                Assumption.assertNotNull(Const.StatusCodes.UPDATE_OPTIONS_NULL_INPUT, respondingInstructorSet);

                updateOptions.respondingInstructorSetOption = UpdateOption.of(respondingInstructorSet);
                return this;
            }
        ...
        public String toString() {
            return "StudentAttributes.UpdateOptions ["
                    ...
                    + ", createdTime = " + createdTimeOption
                    + ", deletedTime = " + deletedTimeOption
                    ...
                    + ", isOpeningEmailEnabled = " + isOpeningEmailEnabledOption
                    + ", isClosingEmailEnabled = " + isClosingEmailEnabledOption
                    + ", isPublishedEmailEnabled = " + isPublishedEmailEnabledOption
                    + ", respondingStudentSet = " + respondingStudentSetOption
                    + ", respondingInstructorSet = " + respondingInstructorSetOption
