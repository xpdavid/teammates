...
public final class FeedbackSessionsLogic {
    ...
    public void updateFeedbackSession(FeedbackSessionAttributes.UpdateOptions updateOptions)
        ...
        fsDb.updateFeedbackSession(newUpdateOptions.build());
    }
    ...
    public void updateFeedbackSessionsTimeZoneForCourse(String courseId, ZoneId courseTimeZone) {
        ...
        fsForCourse.forEach(fs -> {
            try {
                ...
                // almost impossible to hit the case
    ...
    /**
     * Unpublishes the feedback session {@code sessionToUnpublish}.
     *
    ...
    public Instant moveFeedbackSessionToRecycleBin(String feedbackSessionName, String courseId)
        ...
        FeedbackSessionAttributes updatedFs = fsDb.updateFeedbackSession(
                FeedbackSessionAttributes.updateOptionsBuilder(feedbackSessionName, courseId)
                        .withDeletedTime(Instant.now())
                        .build()
        );

        return updatedFs.getDeletedTime();
    }
