...
public final class StudentsLogic {
    ...
    public void updateStudentCascade(StudentAttributes.UpdateOptions updateOptions)
            throws InvalidParametersException, EntityDoesNotExistException {
        updateStudentCascade(updateOptions, true);
    }

    public void updateStudentCascadeWithoutDocument(StudentAttributes.UpdateOptions updateOptions)
            throws InvalidParametersException, EntityDoesNotExistException {
        updateStudentCascade(updateOptions, false);
    }

    public void updateStudentCascade(StudentAttributes.UpdateOptions updateOptions, boolean hasDocument)
            throws InvalidParametersException, EntityDoesNotExistException {
        StudentAttributes originalStudent = getStudentForEmail(updateOptions.getCourseId(), updateOptions.getEmail());
        StudentAttributes updatedStudent = updateStudentCascadeEmailChange(updateOptions, hasDocument);
    ...
    public StudentAttributes updateStudentCascadeEmailChange(
            StudentAttributes.UpdateOptions updateOptions, boolean hasDocument)
            throws EntityDoesNotExistException, InvalidParametersException {
        StudentAttributes originalStudent = getStudentForEmail(updateOptions.getCourseId(), updateOptions.getEmail());
        StudentAttributes updatedStudent = studentsDb.updateStudent(updateOptions, hasDocument, false);
    ...
    private StudentEnrollDetails enrollStudent(StudentAttributes validStudentAttributes, Boolean hasDocument)
        ...
        if (validStudentAttributes.isEnrollInfoSameAs(originalStudentAttributes)) {
            ...
            updateStudentCascadeEmailChange(
