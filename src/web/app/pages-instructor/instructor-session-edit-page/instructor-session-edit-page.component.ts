...
export class InstructorSessionEditPageComponent implements OnInit {
  ...
  loadFeedbackSession(): void {
    ...
    this.httpRequestService.get('/session', paramMap)
        .subscribe((feedbackSession: FeedbackSession) => {
          this.syncSessionEditFormModel(feedbackSession);
          this.sessionEditFormModel.courseName = 'Use Course API'; // TODO

          // update UI status
          this.sessionEditFormModel.hasVisibleSettingsPanelExpanded =
          ...
          this.sessionEditFormModel.hasEmailSettingsPanelExpanded =
              !feedbackSession.isClosingEmailEnabled || !feedbackSession.isPublishedEmailEnabled;
  ...
  /**
   * Syncs the {@code sessionEditFormModel} with {@link FeedbackSession} model.
   */
  syncSessionEditFormModel(feedbackSession: FeedbackSession): void {
    this.sessionEditFormModel.courseId = feedbackSession.courseId;
    this.sessionEditFormModel.timeZone = feedbackSession.timeZone;
    this.sessionEditFormModel.feedbackSessionName = feedbackSession.feedbackSessionName;
    this.sessionEditFormModel.instructions = feedbackSession.instructions;
    ...
    this.sessionEditFormModel.submissionStartTime = submissionStart.time;
    this.sessionEditFormModel.submissionStartDate = submissionStart.date;
    this.sessionEditFormModel.gracePeriod = feedbackSession.gracePeriod;
    ...
    this.sessionEditFormModel.submissionEndTime = submissionEnd.time;
    this.sessionEditFormModel.submissionEndDate = submissionEnd.date;

    this.sessionEditFormModel.sessionVisibleSetting = feedbackSession.sessionVisibleSetting;
    if (feedbackSession.customSessionVisibleTimestamp) {
      ...
      this.sessionEditFormModel.customSessionVisibleTime = customSessionVisible.time;
      this.sessionEditFormModel.customSessionVisibleDate = customSessionVisible.date;
    }
    this.sessionEditFormModel.responseVisibleSetting = feedbackSession.responseVisibleSetting;
    if (feedbackSession.customResponseVisibleTimestamp) {
      ...
      this.sessionEditFormModel.customResponseVisibleTime = customResponseVisible.time;
      this.sessionEditFormModel.customResponseVisibleDate = customResponseVisible.date;
    }

    this.sessionEditFormModel.submissionStatus = feedbackSession.submissionStatus;
    this.sessionEditFormModel.publishStatus = feedbackSession.publishStatus;

    this.sessionEditFormModel.isClosingEmailEnabled = feedbackSession.isClosingEmailEnabled;
    this.sessionEditFormModel.isPublishedEmailEnabled = feedbackSession.isPublishedEmailEnabled;
  }
